...
class Myoleg_env_v0(BaseV0,env_base.MujocoEnv):
    ...
    def get_inter_force_penalty(self, torque):
        inter_force_penalty = np.absolute(torque)
        #if inter_force_penalty > 50:
        #    inter_force_penalty = 1000
    ...
    def get_reward_dict(self, obs_dict):
        ...
        #print("Reward", rwd_dict['dense'], "Error", pose_err, "Pos_score", pose_reward*2, "Act_penalty:", -0.1*(action_penalty), "acceleration_penalty", -0.1*acc_penalty)
        return rwd_dict
