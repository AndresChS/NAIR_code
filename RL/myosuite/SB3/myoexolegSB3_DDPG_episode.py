...
def main(cfg):  # noqa: F821
    ...
    # Mean and sigma arrays for action noise
    mean = np.zeros(n_actions)
    sigma = np.zeros(n_actions)
    sigma[0] = 0.1  # Apply noise only to the first action

    # Create NormalActionNoise with custom mean and sigma
