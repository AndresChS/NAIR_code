...
# --------------------------------------------------------------------
model = sconepy.load_model(sconegym_path+"/sconegym/nair_envs/H0918_Spasticity/H0918_KneeExoRLV0.scone")
model.reset()
store_data = True
...
"""
if store_data:
	filename = model.name() + f'_{model.time():0.2f}_'+ today + "test_exo"
